...
- if that function is called again with the *same* set of arguments, we pull the return value from the cache rather than recomputing it 
...
![](./img/drake_cache_hashes_small.jpg)
