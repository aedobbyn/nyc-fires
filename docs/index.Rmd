...
Luckily, `drake` knows the *all* the dependency relationships between functions as they relate to your targets.
...
<!-- <p> -->
<!-- <img src="./img/fire_sums_plot.png" height="500px" width="500px"> -->
<!-- </p> -->
